...
| [cloud-bootstrap.md](./cloud-bootstrap.md) | Στήσιμο cloud σε 3 βήματα (schema.sql στο SQL Editor → deploy-functions → secrets). Ποιος στήνει τι (άδειο PC vs cloud). |
| [cloud-migration.md](./cloud-migration.md) | Μεταφορά cloud σε νέο Supabase project ή άλλον Postgres host: τι περιέχει το dump, secrets (ονόματα), edge functions, βήματα, φορητότητα. |
| [deployment.md](./deployment.md) | Εγκατάσταση σε πελάτη (Windows): Server ως service, σταθμοί Ταμείου/Ελεγκτή (kiosk browser), factory ZIP νέου πελάτη. Αρχεία στο `deploy/`. |
| [cheat-sheet-cloud-setup.md](./cheat-sheet-cloud-setup.md) | Τεχνικό cheat sheet: στήσιμο Supabase, Email (Resend/MS365), Viva, πάροχος myDATA — κάθε πεδίο, πού το βρίσκεις, πού το βάζεις. (+ PDF: `Cheat-Sheet-Cloud-Setup.pdf`) |
| [ΟΔΗΓΟΣ-Windows-Service-NodeJS.md](./ΟΔΗΓΟΣ-Windows-Service-NodeJS.md) | Γενικός οδηγός: Node.js app ως Windows Service (Task Scheduler, SYSTEM, auto-restart). |
